...
set(ALL_ASAN_SUPPORTED_ARCH ${X86} ${X86_64} ${ARM32} ${ARM64}
  ${MIPS32} ${MIPS64} ${PPC64})
set(ALL_SHUFFLER_SUPPORTED_ARCH ${X86} ${X86_64})
...
if(APPLE)
  ...
  list_intersect(SHUFFLER_SUPPORTED_ARCH
    ALL_SHUFFLER_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(SHUFFLER_SUPPORTED_ARCH ${ALL_SHUFFLER_SUPPORTED_ARCH})
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND SHUFFLER_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_SHUFFLER TRUE)
else()
  set(COMPILER_RT_HAS_SHUFFLER FALSE)
endif()
